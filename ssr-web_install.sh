...
echo "#             年少不风流 怎为少年郎                         #"
echo "#          Author: FunctionClub                             #"
echo "#   github: https://github.com/FunctionClub/SSR-Bash-Python #"
echo "#############################################################"
echo
#Disable China
...
#UNInstall SSR
wget -N --no-check-certificate https://raw.githubusercontent.com/FunctionClub/SSR-Bash-Python/master/uninstall.sh
