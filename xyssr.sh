...
function adduser(){
    ...
    read -p "(Default password: xiaoyu1206):" shadowsockspwd
	...
	#添加用户
	cd ${ssrdir}
	python mujson_mgr.py -a -p ${shadowsocksport} -k ${shadowsockspwd} -m chacha20 -O auth_sha1_v4_compatible -o http_simple_compatible
